...
redirectToUploadDocument = (UUID) => {
    location.href = "/UploadDocument?UUID="+UUID;
}
redirectToApproval = () => {
    location.href = "../kyc/dsr/dsr-approval.html";
}
redirectToRejected = () => {
    location.href = "../kyc/dsr/rejected.html";
}
redirectToDsrKycLink = () => {
    location.href = "../dsr/dsr-kyc-link.html";
}
sendlink = () => {
    Swal.fire({
        icon: 'success',
