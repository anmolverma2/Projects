...
redirectToUploadDocument = () => {
    location.href = "../kyc/store/upload-document.html";
}
redirectToApproval = () => {
    location.href = "../kyc/store/store-approval.html";
}
redirectToRejected = () => {
    location.href = "../kyc/store/rejected.html";
}
redirectToStoreKycLink = () => {
    location.href = "../store/store-kyc-link.html";
}
